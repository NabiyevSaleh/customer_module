...
import growlab.customer.dto.UpdatedCorporateCustomerDetail;
...
public class CorporateCustomerDetailRepository {
    ...
    private final RowMapper<CorporateCustomerDetail> corporateCustomerDetailsRowMapper;

    public Integer create(CorporateCustomerDetail corporateDetails) {
        ...
        jdbc.update(sql,
                new MapSqlParameterSource()
                        .addValue("customerId", corporateDetails.getCustomerId())
                        .addValue("inn", corporateDetails.getInn())
                        .addValue("registerTaxAuthority", corporateDetails.getRegisterTaxAuthority()),
                keyHolder);
        return keyHolder.getKey().intValue();
    }

    public CorporateCustomerDetail getById(Integer id) {
    ...
    public List<CorporateCustomerDetail> getAll() {
        String sql = "SELECT * FROM corporate_customer_details";
        return jdbc.query(sql, corporateCustomerDetailsRowMapper);
    }

    public void update(Integer id, UpdatedCorporateCustomerDetail request) {
